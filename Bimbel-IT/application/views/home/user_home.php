    ...
    <div class="entry-w3pvt-main py-5">
        <div class="container px-lg-5 py-md-3">
            <div class="entry-w3layouts-info">
                ...
                <p>Disini kami akan membuat anda nyaman dan akan membuat anda cepat mahir atau profesional dalam bidang yang anda pelajari</p>
            </div>
        </div>
    </div>
    <!-- //entry -->
