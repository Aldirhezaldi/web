    ...
    <div class="container" style="margin-top:20px">
        <div class="col-md-12">
            <h1 style="text-align: center; margin-bottom:30px"> Data Guru</h1>
        </div>
            ...
            <tbody id="show_data">
                ...
                foreach ($guru as $gr) { ?>
                    <tr>
                        ...
                        <td> <?= $gr['alamat']; ?></td>
                        <td> <?= $gr['deskripsi']; ?></td>
                        <td> <a href="<?= base_url(); ?>home/hapusguru/<?= $gr['id_guru']; ?>" class="badge badge-danger" onclick="return confirm('Yakin Data ini akan dihapus?');">Hapus</a>
                            <a href="<?= base_url(); ?>home/edit_guru/<?= $gr['id_guru']; ?>" class="badge badge-success">Edit</a>
                            <!-- <a href="<?= base_url(); ?>home/detail_guru/<?= $gr['id_guru']; ?>/<?= $gr['nama_mapel']; ?>/<?= $gr['alamat']; ?>" class="badge badge-primary">Detail</a></td> -->
                    </tr>
                <?php } ?>
