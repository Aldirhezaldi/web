			...
			<div class="row">
                ...
                <div class="col-md-8">
                    <table class="table">
                        ...
                        <tr>
                            <td>Harga</td>
                            <td><strong><div class="btn btn-sm btn-success">Rp. <?=number_format($p->harga_produk, 0, ',', '.') ?></div></strong></td>
                        </tr>
                    </table>
                    <?= anchor('admin/DataProduk', '<div class="btn btn-sm btn-primary float-right">Kembali</div>') ?>
                </div>
            </div>
            <?php endforeach ?>
		</div>
