        ...
        <div class="container px-lg-5">
          ...
          <div class="row mt-4">
            <div class="col-md-6">
              <a class="btn btn-primary" href="<?= base_url(); ?>adm_tambah_pim/tambah">Tambah Data</a>
              <a class="btn btn-primary" href="<?= base_url(); ?>adm_users_pim/laporan_pdf">Cetak Laporan</a>
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-md-8">
