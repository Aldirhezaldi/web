                ...
                <tbody>
                    ...
                    foreach ($surat_peminjaman as $pjm) : ?>
                        <tr>
                            ...
                            <td><?= $pjm->pinjam ?></td>
                            <td> <a href="<?= base_url(); ?>adm_detail_pjm/detail/<?= $pjm->id_pinjam ?>" class="fas fa-info-circle">Detail</a>
                                <a href="" class="fas fa-edit">Edit</a>
                                <a href="<?= base_url(); ?>adm_detail_pjm/surat_pdf/<?= $pjm->id_pinjam ?>" class="fas fa-print">Cetak</a>
