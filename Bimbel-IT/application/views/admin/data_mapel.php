    ...
    <div class="container" style="margin-top:20px">
        <div class="col-md-12">
            <h1 style="text-align: center; margin-bottom:30px"> Data Mapel</h1>
        </div>
            ...
            <tbody id="show_data">
                ...
                foreach ($mapel as $mpl) { ?>
                    <tr>
                        ...
                        <td> <?= $mpl->deskripsi; ?></td>
                        <td> <a href="<?= base_url(); ?>home/hapusmapel/<?= $mpl->id_mapel; ?>" class="badge badge-danger" onclick="return confirm('Yakin Data ini akan dihapus?');">Hapus</a>
                            <a href="<?= base_url(); ?>home/edit_mapel/<?= $mpl->id_mapel; ?>" class="badge badge-success">Edit</a>
                            <a href="<?= base_url(); ?>home/detail_mapel/<?= $mpl->id_mapel; ?>" class="badge badge-primary">Detail</a>
                    </tr>
                <?php } ?>
