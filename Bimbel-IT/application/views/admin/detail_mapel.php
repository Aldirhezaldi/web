    ...
    <section class="banner-bottom py-5" id="exp">
        <div class="container py-md-4">
            <h3 class="tittle-w3layouts two text-center">Detail Data Mapel</h3>
            <div class="row mid-grids mt-5">
                <div class="col-md-5 content-w3pvt-img">
                    <img src="<?= base_url() . '/assets/images/' . $mapel['image'] ?>" alt="" class="img-fluid">
                </div>
                <div class="col-md-7 content-left-bottom entry-w3layouts-info text-left mt-3">
                    <a>Nama Mapel : <?= $mapel['nama_mapel']; ?></a>
                    <br><br>
                    <a>Kode Mapel : <?= $mapel['kode_mapel']; ?></a>
                    <br><br>
                    <a>Deskripsi : <?= $mapel['deskripsi']; ?></a>
                    <br><br><br><br>
                    <a href="<?= base_url(); ?>home/data_mapel" class="btn btn-primary">Kembali</a>
                </div>
